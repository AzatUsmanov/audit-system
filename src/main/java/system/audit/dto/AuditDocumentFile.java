...
/**
 * Класс, используемый для хранения информации о фойлах для аудитов
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Entity
@Table(name = "audit_document_files")
public class AuditDocumentFile implements MultipartFile {
    ...
    public AuditDocumentFile(MultipartFile file) {
        try {
